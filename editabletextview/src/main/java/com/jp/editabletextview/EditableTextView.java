...
import com.jp.edittabletextview.R;

/**
 * @author jpwang
 * @since 06/20/2016
 */
public class EditableTextView extends RelativeLayout implements EditableEditText.OnEditTextListener, View.OnFocusChangeListener {

    private RelativeLayout rlContainer;
    private ImageView ettImageView;
    private TextView ettTextView;
    private EditableEditText ettEditText;
    ...
    public EditableTextView(Context context, AttributeSet attrs) {
        ...
        ettEditText = (EditableEditText) findViewById(R.id.ettEditText);
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.EditableTextView,
                0, 0);

        try {
            emptyStyle = a.getInt(R.styleable.EditableTextView_ettEmptyTexStyle, 2);
            emptyColor = a.getColor(R.styleable.EditableTextView_ettEmptyColor, emptyColor);
            textColor = a.getColor(R.styleable.EditableTextView_ettTextColor, textColor);
            selectOnFocus = a.getBoolean(R.styleable.EditableTextView_ettSelectAllOnEditMode, true);
            showHint = a.getBoolean(R.styleable.EditableTextView_ettShowHint, true);
            icon = a.getResourceId(R.styleable.EditableTextView_ettIcon, 0);
            iconEmpty = a.getResourceId(R.styleable.EditableTextView_ettIconEmpty, icon);
            iconInEditMode = a.getResourceId(R.styleable.EditableTextView_ettIconInEditMode, icon);
            locked = a.getBoolean(R.styleable.EditableTextView_ettLocked, false);

            /* Text Size */
            int textSize = a.getDimensionPixelSize(R.styleable.EditableTextView_ettTextSize, getScaledPixels(16));
            ...
            /* Input Type */
            int inputType = a.getInt(R.styleable.EditableTextView_android_inputType, EditorInfo.TYPE_TEXT_FLAG_CAP_SENTENCES);
            ettEditText.setInputType(inputType);

            int maxLines = a.getInt(R.styleable.EditableTextView_ettMaxLines, 1);
            ettEditText.setMaxLines(maxLines);

            int maxEms = a.getInt(R.styleable.EditableTextView_ettMaxEms, 0);
            if (maxEms > 0) {
                ettEditText.setMaxEms(maxEms);
            }

            setEmptyText(a.getString(R.styleable.EditableTextView_ettEmptyText));
            setText(a.getString(R.styleable.EditableTextView_ettText));

            /* Margins */
            /*int marginTopBottom = a.getDimensionPixelSize(R.styleable.EditableTextView_ettMarginTopBottom, getPixels(8) + (textSize - getPixels(12)));

            if (marginTopBottom < 0)
                marginTopBottom = getPixels(8) + (textSize - getPixels(12));

            int iconMarginLeft = a.getDimensionPixelSize(R.styleable.EditableTextView_ettIconMarginLeft, getPixels(16));
            int iconMarginRight = a.getDimensionPixelSize(R.styleable.EditableTextView_ettIconMarginRight, getPixels(32));
            ...
            int textMarginLeft = a.getDimensionPixelSize(R.styleable.EditableTextView_ettTextMarginLeft, getPixels(0));
            int textMarginRight = a.getDimensionPixelSize(R.styleable.EditableTextView_ettTextMarginLeft, getPixels(8));
     ...
     */
    public void setEditTextViewListener(EditableTextViewListener listener) {
